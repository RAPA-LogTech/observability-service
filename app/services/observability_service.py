# JVM 메트릭만 반환
def list_jvm_metrics(service: str | None = None, start: int | None = None, end: int | None = None) -> list[dict] | dict[str, Any]:
...
# Latency 메트릭만 반환
def list_latency_metrics(service: str | None = None, start: int | None = None, end: int | None = None) -> list[dict] | dict[str, Any]:
    from concurrent.futures import ThreadPoolExecutor, as_completed
...
# Infra 메트릭만 반환 (CPU, Memory 등)
def list_infra_metrics(service: str | None = None, start: int | None = None, end: int | None = None) -> list[dict] | dict[str, Any]:
    from concurrent.futures import ThreadPoolExecutor, as_completed
